...
bOilPlugIn.prototype = {
    ...
    clearAlertMsg: function () {
      var _this = this;
        if ($('.mask').length) {
          if(_this.clearTime1) {window.clearTimeout(_this.clearTime1);}
          $('.mask').remove();
        }
    },
    ...
    middleText: function (className, thisElement, isClear) {
        ...
        if (!(isClear == 'noClear') && !(isClear == 'noclear')) {
            ...
            //2秒后自动隐藏
            _this.clearTime1 = setTimeout(function () {
                if (!_this.status) {
    ...
    tips: function (config) {
        ...
        o = {
            ...
            btnSureId:config.btnSureId || "btnSure"
        },
        ...
        if (o.btnNums === 1) {
            ...
            btnHtml = '<div class="btnCont"><a id="'+ o.btnSureId+'" class="btn btn-danger" href="' + o.btn.btnSure.href + '">' + o.btn.btnSure.text + '</a></div>';
        } else if (o.btnNums === 2) {
            //确定按钮是否带回调函数
            refreshVSbtncb();
            ...
            btnHtml = '<div class="btnCont clear">' +
                '<span class="left"><a id="btnCancle" class="btn btn-cancle two-left" href="' + o.btn.btnCancle.href + '">' + o.btn.btnCancle.text + '</a></span>' +
                '<span class="right"><a id="'+ o.btnSureId+'" class="btn btn-submit two-right" href="' + o.btn.btnSure.href + '">' + o.btn.btnSure.text + '</a></span></div>';
        }
